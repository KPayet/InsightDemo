# some functions that I use often and are helpful

canvas = function( width=16 , height=9 , mag=1.0 , ... ) {
...
hdi = function(sampleVec , mass = 0.95 ) {
    sortedPts = sort( sampleVec )
    ciIdxInc = ceiling( mass * length( sortedPts ) )
